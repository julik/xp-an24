...
defineProperty("left_wing_fire_led", loadImage("fire_lamps.png", 0, 0, 80, 64)) 
defineProperty("left_nacelle_fire_led", loadImage("fire_lamps.png", 103, 0, 80, 64)) 
defineProperty("right_nacelle_fire_led", loadImage("fire_lamps.png", 202, 0, 80, 64)) 
defineProperty("ru19_eng_fire_led", loadImage("fire_lamps.png", 301, 0, 80, 64)) 
defineProperty("right_wing_fire_led", loadImage("fire_lamps.png", 400, 0, 80, 64)) 
