...
-- images
defineProperty("background", loadImage("ground_service.png", 0, 0, size[1], size[2])) 
defineProperty("yellow", loadImage("ground_service.png", 128, 486, 22, 22))
defineProperty("green", loadImage("ground_service.png", 362, 487, 22, 22)) 
defineProperty("empty", loadImage("ground_service.png", 0, 0, 1, 1)) 
