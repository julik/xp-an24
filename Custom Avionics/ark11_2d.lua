...
-- buttons
defineProperty("butP", loadImage("radio_panel_2d.png", 2, 693, 30, 30))
defineProperty("but1", loadImage("radio_panel_2d.png", 31, 693, 30, 30))
defineProperty("but2", loadImage("radio_panel_2d.png", 60, 693, 30, 30))
defineProperty("but3", loadImage("radio_panel_2d.png", 90, 693, 30, 30))
defineProperty("but4", loadImage("radio_panel_2d.png", 120, 693, 30, 30))
defineProperty("but5", loadImage("radio_panel_2d.png", 150, 693, 30, 30))
defineProperty("but6", loadImage("radio_panel_2d.png", 180, 693, 30, 30))
defineProperty("but7", loadImage("radio_panel_2d.png", 210, 693, 30, 30))
defineProperty("but8", loadImage("radio_panel_2d.png", 240, 693, 30, 30))
defineProperty("but9", loadImage("radio_panel_2d.png", 270, 693, 30, 30))
-- knobs
defineProperty("rot_switch", loadImage("rot_switch.png"))
defineProperty("knob_close", loadImage("radio_panel_2d.png", 0, 745, 116, 116))
defineProperty("knob_open", loadImage("radio_panel_2d.png", 132, 745, 116, 116))
defineProperty("knob_simple", loadImage("radio_panel_2d.png", 260, 745, 116, 116))
-- tumbler
defineProperty("tmb_left", loadImage("tumbler_left.png"))
defineProperty("tmb_right", loadImage("tumbler_right.png"))
defineProperty("tmb_ctr_hor", loadImage("tumbler_center_hor.png"))
