...
-- fuel pressure
defineProperty("fuel_p", globalPropertyf("sim/cockpit2/engine/indicators/fuel_pressure_psi[2]"))

-- oil pressure
defineProperty("oil_p", globalPropertyf("sim/cockpit2/engine/indicators/oil_pressure_psi[2]"))

-- oil temperature
defineProperty("oil_t", globalPropertyf("sim/cockpit2/engine/indicators/oil_temperature_deg_C[2]"))
