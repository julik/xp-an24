...
defineProperty("needle_q_left", loadImage("needles.png", 32, 95, 17, 141)) 
defineProperty("needle_q_right", loadImage("needles.png", 48, 95, 17, 141)) 
defineProperty("needle_long", loadImage("needles.png", 67, 70, 16, 179)) 

defineProperty("digitsImage", loadImage("white_digit_strip.png", 0, 0, 16, 196))

defineProperty("yellow_cap", loadImage("covers.png", 204, 0, 56, 56)) -- yellow cap image
defineProperty("background", loadImage("fuel_panel_2d.png", 0, 0, 512, 725)) -- yellow cap image
defineProperty("mode_ndl_img", loadImage("fuel_panel_2d.png", 6, 779, 30, 142)) -- mode switcher needle
