...
defineProperty("bg", loadImage("NAS1.png", 0, 0, 1024, 557))

defineProperty("northneedle", loadImage("NAS1.png", 32, 863, 17, 141)) 
defineProperty("eastneedle", loadImage("NAS1.png", 48, 863, 17, 141)) 
defineProperty("curse_needle", loadImage("needles.png", 218, 70, 87, 179))
defineProperty("needle_1", loadImage("NAS1.png", 463, 783, 23, 237))
defineProperty("needle_2", loadImage("NAS1.png", 403, 839, 28, 177))

defineProperty("northoverlay", loadImage("NAS1.png", 0, 562, 35, 35))
defineProperty("eastoverlay", loadImage("NAS1.png", 0, 598, 35, 35))
defineProperty("overlay", loadImage("NAS1.png", 0, 634, 35, 35))
defineProperty("windoverlay", loadImage("NAS1.png", 142, 608, 90, 116))
defineProperty("windoverlay2", loadImage("NAS1.png", 0, 762, 42, 42))

defineProperty("delta_needle", loadImage("NAS1.png", 205, 830, 25, 146))
defineProperty("map_needle", loadImage("kppm.png", -0.5, 0.5, 196, 196))

defineProperty("speed_needle", loadImage("NAS1.png", 252, 830, 11, 56))

defineProperty("yellow", loadImage("NAS1.png", 0, 691, 263, 17))
defineProperty("large_scale", loadImage("NAS1.png", 896, 558, 128, 128))
defineProperty("checker", loadImage("NAS1.png", 791, 597, 40, 16))

defineProperty("rotary", loadImage("rot_switch.png"))
