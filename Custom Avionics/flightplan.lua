...
defineProperty("bg", loadImage("flightplan.png", 5, 3, size[1], size[2]))
defineProperty("stroked1", loadImage("flightplan.png", 733, 85, 291, 13))
defineProperty("stroked2", loadImage("flightplan.png", 733, 98, 291, 13))
defineProperty("stroked3", loadImage("flightplan.png", 733, 111, 291, 13))
defineProperty("deselected", loadImage("flightplan.png", 756, 473, 22, 22))
defineProperty("APselected", loadImage("flightplan.png", 135, 473, 22, 22))
defineProperty("white", loadImage("flightplan.png", 20, 15, 5, 5))
