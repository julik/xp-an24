...
defineProperty("background", loadImage("ap_panel_2d.png", 0, 0, size[1], size[2]))
defineProperty("knob_img", loadImage("ap_panel_2d.png", 6, 410, 95, 95))
...
defineProperty("small_btn_dn", loadImage("ap_panel_2d.png", 122, 439, 36, 36))
defineProperty("small_btn_up", loadImage("ap_panel_2d.png", 164, 439, 36, 36))

defineProperty("flap_up_img", loadImage("right_panel_2d.png", 831, 117, 66, 66))
defineProperty("flap_ctr_img", loadImage("right_panel_2d.png", 831, 330, 66, 66))
defineProperty("flap_dn_img", loadImage("right_panel_2d.png", 831, 259, 66, 66))

defineProperty("gear_up_img", loadImage("right_panel_2d.png", 906, 117, 66, 66))
defineProperty("gear_ctr_img", loadImage("right_panel_2d.png", 906, 187, 66, 66))
defineProperty("gear_dn_img", loadImage("right_panel_2d.png", 906, 259, 66, 66))
