...
-- images
defineProperty("green_led", loadImage("gear_lamps.png", 53, 2, 5, 10))
defineProperty("red_vert_led", loadImage("gear_lamps.png", 42, 10, 5, 10))
defineProperty("red_hor_led", loadImage("gear_lamps.png", 40, 2, 9, 5))

defineProperty("gear_led", loadImage("gear_lamps.png", 0, 0, 36, 21))
defineProperty("flaps_led", loadImage("gear_lamps.png", 0, 22, 36, 21))
