...
defineProperty("bg", loadImage("rsbn.png", 0, 0, 1024, 724))
defineProperty("rotary", loadImage("rot_switch.png"))
defineProperty("detailed", loadImage("rsbn.png", 0, 731, 150, 150))
defineProperty("glass_cap", loadImage("rsbn.png", 11, 895, 78, 32))

defineProperty("digitsImage", loadImage("white_digit_strip.png", 0, 0, 16, 196))
defineProperty("needle1", loadImage("needles.png", 311, 73, 18, 173))
defineProperty("needle2", loadImage("rsbn.png", 205, 774, 22, 158))
