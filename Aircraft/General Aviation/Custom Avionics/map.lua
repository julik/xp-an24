...
-- add map textures
defineProperty("map_1", loadImage("map_1.png"))
defineProperty("map_2", loadImage("map_2.png"))
defineProperty("map_3", loadImage("map_3.png"))
defineProperty("map_4", loadImage("map_4.png"))
defineProperty("map_5", loadImage("map_5.png"))

-- texture table
defineProperty("cover", loadImage("map_cover.png", 0, 0, 350, 365))
defineProperty("num_1", loadImage("map_cover.png", 379, 7, 32, 13))    
defineProperty("num_2", loadImage("map_cover.png", 379, 26, 32, 13))   
defineProperty("num_3", loadImage("map_cover.png", 379, 46, 32, 13))   
defineProperty("num_4", loadImage("map_cover.png", 379, 66, 32, 13))   
defineProperty("num_5", loadImage("map_cover.png", 379, 86, 32, 13))   
defineProperty("size_025", loadImage("map_cover.png", 379, 107, 32, 13))   
defineProperty("size_05", loadImage("map_cover.png", 379, 125, 32, 13))    
defineProperty("size_1", loadImage("map_cover.png", 379, 144, 32, 13))  
defineProperty("size_2", loadImage("map_cover.png", 379, 164, 32, 13))  
defineProperty("size_4", loadImage("map_cover.png", 379, 185, 32, 13)) 

defineProperty("closeImage", loadImage("close.png"))  -- altimeter handler image
