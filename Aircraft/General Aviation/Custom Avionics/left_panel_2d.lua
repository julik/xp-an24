...
-- images
defineProperty("background", loadImage("left_panel_2d.png", 0, 0, 983, 512))
...
defineProperty("needles_thin", loadImage("needles.png", 336, 103, 1, 110)) 
defineProperty("black_cap", loadImage("covers.png", 0, 55, 56, 56)) -- black cap image

defineProperty("small_btn_dn", loadImage("fuel_panel_2d.png", 181, 817, 34, 36))
defineProperty("small_btn_up", loadImage("fuel_panel_2d.png", 224, 817, 34, 36))

defineProperty("yellow_cap_close", loadImage("fuel_panel_2d.png", 369, 726, 44, 163))
defineProperty("yellow_cap_open", loadImage("fuel_panel_2d.png", 416, 726, 44, 163))

defineProperty("red_cap_close", loadImage("fuel_panel_2d.png", 272, 726, 44, 163))
defineProperty("red_cap_open", loadImage("fuel_panel_2d.png", 319, 726, 44, 163))

defineProperty("red_sidecap_close", loadImage("fuel_panel_2d.png", 43, 890, 162, 42))
defineProperty("red_sidecap_open", loadImage("fuel_panel_2d.png", 43, 936, 162, 42))

defineProperty("ru_cap_close", loadImage("fuel_panel_2d.png", 47, 729, 117, 71))
defineProperty("ru_cap_open", loadImage("fuel_panel_2d.png", 47, 805, 117, 71))
...
defineProperty("red_vent_img", loadImage("fuel_panel_2d.png", 180, 726, 80, 80))

defineProperty("grey_cap", loadImage("covers.png", 406, 0, 56, 56)) 

defineProperty("black_cap1", loadImage("covers.png", 264, 67, 77, 59)) 
defineProperty("black_cap2", loadImage("covers.png", 138, 59, 57, 60)) 
defineProperty("black_cap3", loadImage("covers.png", 202, 60, 57, 60)) 
