...
-- images
defineProperty("needle1", loadImage("needles.png", 463, 15, 23, 237))
defineProperty("needle2", loadImage("needles.png", 488, 15, 23, 237))
defineProperty("scale", loadImage("navigator_panel_2d.png", 359, 718, 305, 305))
