...
-- define images
defineProperty("background", loadImage("electro_panel_2d.png", 0, 0, 512, 870)) 
defineProperty("rot_switch", loadImage("rot_switch.png"))
...
defineProperty("tmb_ctr", loadImage("tumbler_center.png"))

defineProperty("btn_press", loadImage("electro_panel_2d.png", 130, 895, 25, 25))
defineProperty("btn_up", loadImage("electro_panel_2d.png", 171, 895, 25, 25))
defineProperty("stg_cap_close", loadImage("electro_panel_2d.png", 4, 879, 50, 81))
defineProperty("stg_cap_open", loadImage("electro_panel_2d.png", 55, 879, 50, 81))

defineProperty("main_cap_open", loadImage("electro_panel_2d.png", 207, 873, 82, 104))
defineProperty("main_tmb_up", loadImage("electro_panel_2d.png", 115, 967, 24, 43))
defineProperty("main_tmb_ctr", loadImage("electro_panel_2d.png", 145, 967, 24, 43))
defineProperty("main_tmb_dn", loadImage("electro_panel_2d.png", 180, 966, 24, 43))

defineProperty("main_tmb_up_close", loadImage("electro_panel_2d.png", 412, 877, 50, 103))
defineProperty("main_tmb_ctr_close", loadImage("electro_panel_2d.png", 359, 877, 50, 103))
defineProperty("main_tmb_dn_close", loadImage("electro_panel_2d.png", 307, 877, 50, 103))
...
function update()
	...
	if get(GS24_mode) == 0 then GS_amp = get(bus_DC_27_amp) * get(ground_available)  * 220 / 1000 - 100 else GS_amp = get(gs24_amp) * 220 / 1000 - 100 end  -- calculate angle for GS24 ampermeter needle
	...
	elseif AC115_mode == 1 then AC115_volts = get(ground_available) * 115 -- ground power
	...
	if DC_mode == 0 then DC_volts = 27 * get(ground_available)
	elseif DC_mode == 1 then DC_volts = 27 * get(ground_available)
	...
	if get(bus_DC_27_volt_emerg) > 21 then  -- all lamps will not work if even emergency bus down
		...
		ground_led = get(ground_available) > 0 and get(power_mode) == 0
